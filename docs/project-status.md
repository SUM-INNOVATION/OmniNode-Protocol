...
| **Phase 5 Stages 12.20–12.25 & Stage 13 — removed** — The signed-integrity-evidence family (signed integrity baselines/diffs, local integrity-evidence bundles, and integrity-evidence chain reports) and the Stage 13 chain evidence-anchor path were removed (OmniNode #102). The Stage 12.19 integrity diagnostics (`state-integrity`, `state-integrity-diff`) remain. | — | **Removed** |
