...
| Phase 5 Stage 11b.1 — Bounded halo2 reference proof backend + fixture (crates.io halo2-direct; testnet/dev only; not mainnet, not production zkML) | `crates/omni-proofs-halo2-reference/` (new), `.github/workflows` | Planned |
